...
fun MainScreen(modifier: Modifier = Modifier) {
  ...
  val checkedStateList = remember { List(10) { false }.toMutableStateList() }
  Scaffold(floatingActionButton = {
    ...
    Column(
      ...
      LazyColumn(verticalArrangement = Arrangement.spacedBy(8.dp)) {
        itemsIndexed(checkedStateList) { index, isItemChecked ->
          TodoItem("Title $index", isItemChecked) { isChecked ->
